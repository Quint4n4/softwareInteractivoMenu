"""
Configuración de Django — Plataforma Vitrina Digital (SaaS multi-tenant).
Lee variables de entorno (.env). Por defecto usa SQLite para desarrollo.
"""
import os
...
# Dominio base para resolver subdominios de tenants (ej. <slug>.tudominio.com)
...
if os.getenv("DB_ENGINE", "sqlite") == "postgres":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "vitrina"),
            "USER": os.getenv("DB_USER", "vitrina"),
...
# CORS: en dev permitimos todo; en prod restringir a los dominios del frontend.
